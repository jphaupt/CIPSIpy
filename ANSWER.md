...
| File | Purpose | Status |
|------|---------|--------|
| `src/CIPSIpy/fcidump.py` | Read molecular integrals | ✅ Complete |
| `src/CIPSIpy/determinants.py` | Slater determinant ops | ⏳ TODO |
| `src/CIPSIpy/hamiltonian.py` | Matrix elements | ⏳ TODO |
| `src/CIPSIpy/cipsi.py` | Main algorithm | ⏳ TODO |
